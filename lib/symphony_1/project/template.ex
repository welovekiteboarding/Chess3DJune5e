defmodule Symphony1.Project.Template do
  ...
  def files(assigns) do
    [
      ...
      {".gitignore", gitignore()},
      {".github/workflows/test.yml", github_actions_workflow()},
  ...
  defp github_actions_workflow do
    """
    name: Test
    ...
    jobs:
      bootstrap-proof:
        ...
        steps:
          ...
          - name: Verify bootstrap proof artifact exists
            run: test -f docs/live-proof-setup-run-merge.md
    """
  end
