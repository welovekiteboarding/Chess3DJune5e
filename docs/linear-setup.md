# Linear Setup For Chess3DJune5e

## Team

- team name: `Chess3DJune5e`
- team key: `C`
- GitHub repo: `welovekiteboarding/Chess3DJune5e`
...
- description:
      ...
      Rules:
      - Run `git branch --show-current` and copy the exact branch output into the Branch line.
      - Do not use the Linear issue identifier as a branch substitute.
